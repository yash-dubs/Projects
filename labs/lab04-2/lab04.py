...
def distance(city_a, city_b):
    ...
    step_1 = pow((a_lat - b_lat), 2)
    step_2 = pow ((a_lon - b_lon), 2)
    return sqrt(step_1 + step_2)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    holder_city = make_city('placeholder', lat, lon)
    if distance(city_a, holder_city) < distance(city_b, holder_city):
